<template>
  <div class="ml-[420px] w-full">
    <div class="w-full">
      ...
      <div id="MessagesSection" class="pt-20 pb-8 z-[-1] h-[calc(100vh-65px)] w-[calc(100vh-420px)] fixed overflow-auto touch-auto">
        <div class="px-20 text-sm">
          <div class="flex w-[calc(100%-50px)]">
            <div class="inline-block bg-white p-2 rounded-md my-1">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, dolore!
            </div>  
          </div>
       ...
       <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0">
                <div class="flex items-center justify-center">
                    <EmotionExcitedOutlineIcon   class="mx-1.5 text-[#515151]" />
                    <PaperclipIcon   class="mx-1.5 mr-3 text-[#515151]" />
                    <input 
                    v-model="message"
                    class="
                        mr-1
...
import EmotionExcitedOutlineIcon from "vue-material-design-icons/EmoticonExcitedOutline.vue";
